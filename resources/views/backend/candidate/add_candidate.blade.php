...
<div class="card">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="candidate_name" class="form-control @error('name') is-invalid @enderror"   >
      ...
      <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Employee Experience/stage    </label>
